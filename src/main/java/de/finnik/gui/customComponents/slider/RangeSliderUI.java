...
public class RangeSliderUI extends BasicSliderUI {
    ...
    public Color lowerThumbFill = Color.BLACK;
    public Color lowerThumbDraw = Color.WHITE;
    public Color upperThumbFill = Color.BLACK;
    public Color upperThumbDraw = Color.WHITE;
    /**
